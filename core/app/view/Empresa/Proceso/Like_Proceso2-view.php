                                        ...
                                        <div class="col-md-6 col-xl-3">
                                                ...
                                                <div class="main">
                                                        ...
                                                        <div class="panel panel-primary">
                                                                ...
                                                                <img src='index.php?action=Likeimg&id=<?php echo $_GET['id']; ?>&id2=<?php echo$i; ?>' alt='NO IMAGE' width="400" />      
                                                                </div> 
                                                            </div>
                                                </div>
                                                ...
                                                <tr>
                                                   ...
                                                   <td class="text-Center table-actions">
                                                         <div class="btn-group mg-t-10">  
                                                                                 ...
                                                                                 <form action="index.php?view=Edit_Diagnostico" method="post">
                                                                                 <input type="hidden" name="id" value=<?php echo $cliente->id;?>>
                                                                                    <button class="btn btn-secondary" ><i class="fa fa-pencil"></i></button>
                                                                                 </form>
                                                                              

                                                                                 <form action="index.php?action=DelDiagnostico" method="post">   
                                                                                 <input type="hidden" name="id" value=<?php echo $cliente->id;?>>
                                                                  ...
                                                                  <div class="dropdown-menu dropdown-menu-right">
                                                                                 ...
                                                                                 <?php if($cliente->estado!="En Proceso"&& $cliente->estado!="Finalizado"){?>
                                                                                             <form action="index.php?action=AddEjecucion" method="post">   
                                                                                                   <input type="hidden" name="id" value=<?php echo $cliente->id;?>>
                                                                                                   <button class="dropdown-item" type="submit"><i class="fa fa-eye"></i>Iniciar Ejecucion</a>  
                                                                                                   </form>
                                                                                 <?php } ?>


                                                                                    <?php if($cliente->estado=="En Proceso"){?>
                                                                                             <form action="index.php?action=EndEjecucion" method="post">   
                                                                                                   <input type="hidden" name="id" value=<?php echo $cliente->id;?>>
                                                                                                   <button class="dropdown-item" type="submit"></i>Finalizar Ejecucion</a>  
                                                                                                      </form>
                                                                                    <?php } ?>                  
