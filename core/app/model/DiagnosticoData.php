...
class DiagnosticoData{
	...
	public function DiagnosticoData(){
		...
		$this->novedades = null;
		$this->id_user = null;
		$this->mas_tecnicos = null;
        
	} 

	public function add(){
		$sql = "insert into diagnostico (id_proceso,placa,tipo_diagnostico,tiempo_estimado,estado,start_date,start_hour,novedades,id_user,mas_tecnicos) ";
		$sql .= "value (\"$this->id_proceso\",\"$this->placa\",\"$this->tipo_diagnostico\",\"$this->tiempo_estimado\",\"$this->estado\",\"$this->start_date\",\"$this->start_hour\",\"$this->novedades\",\"$this->id_user\",\"$this->mas_tecnicos\")";
